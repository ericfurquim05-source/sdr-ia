...
/** Uma ligação é "quente" quando tem sinal de prioridade 1 ou 2. */
export function ehOportunidade(sinais) {
  // URA/caixa postal não é lead; sem interesse também não
  if (sinais.some((s) => s.id === "ura")) return false;
