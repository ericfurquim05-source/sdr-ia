...
export function normalizarTelefone(bruto) {
  ...
  // NONO DÍGITO: base antiga costuma trazer celular com 10 dígitos.
  // No Brasil, celular começa com 6, 7, 8 ou 9 — fixo começa com 2 a 5.
  // Se tem 10 dígitos e o primeiro do número é de celular, falta o 9:
  // sem essa correção a operadora recusa a chamada.
  if (n.length === 10) {
    const primeiro = n[2];
