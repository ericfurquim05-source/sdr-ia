...
// Segundos mínimos para gerar cobrança. Abaixo disso é artefato de
// conexão, não conversa — cobrar gera reclamação do cliente.
const SEGUNDOS_MINIMOS_COBRANCA = Number(process.env.SEGUNDOS_MINIMOS_COBRANCA || 3);
